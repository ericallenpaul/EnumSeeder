...
namespace EnumSeeder.Service
{
    ...
    public interface IReadOnlyRepository
    {
        ...
        IEnumerable<TEntity> GetSimpleDynamic<TEntity>(
           string filter = null,
           string orderBy = null
           ) where TEntity : class;
    ...
    public class EFReadOnlyRepository<TContext> : IReadOnlyRepository where TContext : DbContext
    {
        ...
        public virtual IEnumerable<TEntity> GetDynamic<TEntity>(
            ...
            where TEntity : class
        {
            return GetQueryableDymanic<TEntity>(filter, orderBy, includeProperties, skip, take, parameters).ToList();
        }

        public virtual IEnumerable<TEntity> GetSimpleDynamic<TEntity>(
          string filter = null,
          string orderBy = null)
          where TEntity : class
        {
            return GetQueryableDymanic<TEntity>(filter, orderBy).ToList();
        }
